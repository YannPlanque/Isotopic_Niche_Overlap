...
### I // Data #############################################################################################
  ## 1 / Direction 
  Direction <- ".../Planque_et_al_Isotopic_Niche_Overlap_V1-4"
  #Direction <- "C:/Users/yplanq01/Documents/CEBC/Article_Planque_et_al_Niche_Overlap/Scripts/Isotopic_Niche_Overlap/Planque_et_al_Isotopic_Niche_Overlap_V1-4"
  ...
  HEI <- 8.5
  ggsave(SI_raw_plot,
         filename = paste(Direction, "Plot", "00_SI_whisker_SI.png", sep = "/"), dpi = 600,
         width = WID, height = HEI
  )
  
  ggsave(SI_raw_plot,
         filename = paste(Direction, "Plot", "00_SI_whisker_SI_PDF.pdf", sep = "/"), dpi = 1000,
         width = WID, height = HEI
  )
...
### Export final plot  ####################################################################################
  ...
  ggsave(Plot_01_02_03,
         filename = paste(Direction, "Plot", "03_02_01_All_plots.png", sep = "/"), dpi = 600,
         width = WID, height = HEI
  )
  
  ggsave(Plot_01_02_03,
         filename = paste(Direction, "Plot", "03_02_01_All_plots_PDF.pdf", sep = "/"), dpi = 1000,
         width = WID, height = HEI
  )
...
### We compared the isotopic values of potential prey (i.e. preferential prey identified in seals' diet) with seal isotopic niches
  ...
  ggsave(Plot_04_potential_Prey_Niche,
         filename = paste(Direction, "Plot", "04_SI_niche_potential_prey.png", sep = "/"), dpi = 600,
         width = WID, height = HEI
  )
  
  ggsave(Plot_04_potential_Prey_Niche,
         filename = paste(Direction, "Plot", "04_SI_niche_potential_prey_PDF.pdf", sep = "/"), dpi = 1000,
         width = WID, height = HEI
  )
